...
def juego1():
    ...
    while not juegoTerminado:
        ...
        while not prediccionValida:
            if (prediccion == "mayor" or prediccion == "menor" or
                prediccion == "MAYOR" or prediccion == "MENOR" or
                prediccion == "Mayor" or prediccion == "Menor"):
                prediccionValida = True
            
                if (prediccion == "mayor" or prediccion == "MAYOR" or 
                    prediccion == "Mayor"):
                    prediccion = "mayor"
                else:
                    prediccion = "menor"
        ...
        if acierto:
            ...
            print(
                RED+ f"¡Le erraste! El numero era {numeroSiguiente}"+ RESET)
  
            print(f"\n{nombre}, ¿Queres seguir jugando?")
            continuar = input("Ingresa 'si' para seguir jugando o 'no' para volver al menu: ")
            
            while (continuar != "si" and continuar != "no" and
                   continuar != "Si" and continuar != "No"):
                print("Por favor ingrese solo 'si' o 'no'")
                continuar = input("Ingresa 'si' para segyur jugando o 'no' para volver al menu: ")
